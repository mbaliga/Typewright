 ...
 *
 * **Flat versus curved, adapted from `qa`'s [dev.aarso.typewright.qa.checkOvershootPresence]
 ...
 *   (CLAUDE.md law 5's "our heuristic", `dev.aarso.typewright.qa.OvershootFinding`'s own note that
