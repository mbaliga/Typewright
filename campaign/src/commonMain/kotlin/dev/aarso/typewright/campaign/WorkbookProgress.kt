 ...
 * That function needs a real compiled font ([dev.aarso.typewright.qa.LayerOneInput]) to check
 ...
 * [dev.aarso.typewright.qa.LayerOneChecker]-needing function here would only ever return the
