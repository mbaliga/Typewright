 ...
 * `learn:scenes` [dev.aarso.typewright.learn.scenes.Scene] because their own content genuinely is
 ...
 * [dev.aarso.typewright.core.font.ufo.UfoProject]/font input.
 *
...
public sealed interface Demonstration {
     ...
     * [dev.aarso.typewright.learn.scenes.Scene] by its stable [sceneId] (e.g.
     * `"craft.c1-baked-composites"`, `"lineages.transitional"` -- both real ids
     * [dev.aarso.typewright.learn.scenes.CraftResources]/[dev.aarso.typewright.learn.scenes.LineagesResources]
     * already load).
     */
 ...
 * ([notImplementedReason] says why, following [dev.aarso.typewright.qa.LayerOneChecker]'s own
 ...
 *   [dev.aarso.typewright.qa.checkAnchorsPresent], and tasks 11/12 check a whole compiled
