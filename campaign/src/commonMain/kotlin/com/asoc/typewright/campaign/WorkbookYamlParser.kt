 ...
 * ([com.asoc.typewright.learn.scenes.yaml.parseYaml]), rather than a library. This is this
 * task's own instruction, for the identical reason
 * [com.asoc.typewright.learn.scenes.yaml]'s own top-of-file KDoc gives for `learn:scenes` itself:
 ...
 *   gate:
 *     summary: "..."
 *     qaFunction: "com.asoc.typewright.qa.checkNodeEconomy"   # omitted when not implemented
