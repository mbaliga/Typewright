...
class WorkbookYamlParserTest {
    ...
    fun parsesATaskWithASceneDemonstrationAndAnImplementedGate() {
        val yaml =
            ...
            - index: 4
              ...
              gate:
                ...
                qaFunction: "com.asoc.typewright.qa.checkNodeEconomy"
                glyphs: [n, o, H, O]
              reflection: >
        ...
        assertEquals("com.asoc.typewright.qa.checkNodeEconomy", gate.qaFunction)
    ...
    fun rejectsAGateWithBothQaFunctionAndNotImplementedReason() {
        val yaml =
            ...
            - index: 1
              ...
              gate:
                summary: "g"
                qaFunction: "com.asoc.typewright.qa.checkAnchorsPresent"
                notImplementedReason: >
                  r
              reflection: >
                Reflect.
