 ...
 * [readSceneResourceText]'s doc comment in commonMain, and `qa/corpus`'s
 * `CorpusResources.wasmJs.kt`, whose identical approach this mirrors. `process.getBuiltinModule`
...
internal actual fun readSceneResourceText(resourcePath: String): String = readNodeFileNextToThisModule(resourcePath)
