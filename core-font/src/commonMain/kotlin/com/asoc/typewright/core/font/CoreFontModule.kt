 ...
 * `core-geometry`'s [com.asoc.typewright.core.geometry.Contour]/[com.asoc.typewright.core.geometry.Glyph]
 ...
 *
 * - [com.asoc.typewright.core.font.sfnt.readSfntFont] reads a binary TrueType (`glyf`-outline)
 *   font — [com.asoc.typewright.core.font.sfnt.ByteCursor] is a hand-written big-endian cursor,
 ...
 *   into plain [com.asoc.typewright.core.geometry.Contour]s), `cmap` (formats 4 and 12), `hmtx`,
 ...
 * - [com.asoc.typewright.core.font.ufo.writeUfoProject]/[com.asoc.typewright.core.font.ufo.readUfoProject]
 ...
 *   [com.asoc.typewright.core.geometry.CurveFormat.CUBIC] contour representation — the format
 *   every glyph this app draws or edits (as opposed to a `glyf`-sourced one, which is
 *   [com.asoc.typewright.core.geometry.CurveFormat.QUADRATIC]) eventually lives in. XML is parsed
 ...
 * ([com.asoc.typewright.core.font.sfnt.HyleDecoCrossCheckTest], commonTest): the sfnt reader's
