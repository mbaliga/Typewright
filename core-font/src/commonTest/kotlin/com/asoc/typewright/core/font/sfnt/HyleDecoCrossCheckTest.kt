 ...
 * `fonts/HyleDeco-Regular.ttf`, produced by feeding [readSfntFont]'s [com.asoc.typewright.core.geometry.Glyph]s
 * through `core-geometry`'s own [com.asoc.typewright.core.geometry.Glyph.count], must equal the
