 ...
 * - one of its contours has a non-empty [dev.aarso.typewright.core.geometry.Contour.extrema]:
 *   by that function's own contract only a curved ([dev.aarso.typewright.core.geometry.CurveSegment.Quadratic]/
 *   [dev.aarso.typewright.core.geometry.CurveSegment.Cubic]) segment ever contributes an extremum
 *   (a straight [dev.aarso.typewright.core.geometry.CurveSegment.Line] contributes none), so this
