...
import com.asoc.typewright.qa.corpus.verdictFor
import kotlin.math.round

/**
 * One glyph's node-economy result: its measured on/off-curve counts (`core-geometry`'s
 * [com.asoc.typewright.core.geometry.count], the exact rule the corpus itself was built with --
 ...
 * different by format: a [com.asoc.typewright.core.geometry.CurveFormat.CUBIC] contour always
