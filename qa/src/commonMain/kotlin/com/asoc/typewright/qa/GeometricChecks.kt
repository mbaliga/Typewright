...
import com.asoc.typewright.core.geometry.Segment
import com.asoc.typewright.core.geometry.angleBetween
import com.asoc.typewright.core.geometry.chords
 ...
 * for the same reason [com.asoc.typewright.qa.checkNodeEconomy] measures the UFO (law 1;
 ...
 * building that map from a [com.asoc.typewright.core.font.ufo.UfoFontInfo] is the caller's job,
 ...
 * [com.asoc.typewright.core.geometry.pointAt] and rounded to the nearest font unit for display.
 */
