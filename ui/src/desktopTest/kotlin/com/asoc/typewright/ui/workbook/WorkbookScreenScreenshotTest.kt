...
import com.asoc.typewright.ui.Screenshot
 ...
 * test already established ([com.asoc.typewright.ui.learn.LearnScreenScreenshotTest]), **except
 ...
 * not [com.asoc.typewright.ui.learn.LearnScreenScreenshotTest]'s own `width = 420, density = 2f`
...
class WorkbookScreenScreenshotTest {
    ...
    fun onBackIsNotInvokedSpuriouslyByAPlainRender() {
        // Not a click-simulation test -- see com.asoc.typewright.ui.learn.LearnScreenScreenshotTest's
