 ...
 * on screen", UI_SPEC section 2) rather than only its geometry ([dev.aarso.typewright.ui.
 ...
 * screen needs real `.hy` **text**, not geometry -- [dev.aarso.typewright.ui.workbook.
 ...
 * [dev.aarso.typewright.learn.scenes.LearnFaceResources] file read, no Node `fs`), so this loads
