 ...
 * than improvised). Its own standalone tab, matching [dev.aarso.typewright.ui.learn.LineagesTab]'s
 ...
 *
 * **Real geometry, not platform text.** [dev.aarso.typewright.ui.learn.LearnFaceFonts]'s own KDoc
 ...
 * expose. Every layer's outline here is real [dev.aarso.typewright.core.geometry.Glyph] data, read
 ...
 * [dev.aarso.typewright.learn.scenes.LearnFaceResources]), converted to a Compose [androidx.compose.ui.graphics.Path]
 * through `GeometryInterop.kt`'s own outline bridge ([dev.aarso.typewright.ui.toComposePath]) --
 ...
 * [dev.aarso.typewright.ui.tokens.MeaningColor] *and* its own dash pattern -- never colour alone
