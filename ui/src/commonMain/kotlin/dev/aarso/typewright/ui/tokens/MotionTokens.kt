 ...
 * easing curve ([dev.aarso.typewright.ui.sheet.CubicBezierEasing.ROOM_PAN]). [RoomFlight][dev.
 * aarso.typewright.ui.sheet.RoomFlight] already models the room pan's own interpolation; this
