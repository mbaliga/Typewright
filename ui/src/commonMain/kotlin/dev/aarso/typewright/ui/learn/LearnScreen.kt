 ...
 * standalone station, not content inside the one-sheet's placeholder [dev.aarso.typewright.ui.
 ...
 * between them.
 *
 * **Header, not [dev.aarso.typewright.ui.glass.Header].** That composable is UI_SPEC §3's
 ...
 * nothing in it [Header] already has a token for beyond [Typography]/[dev.aarso.typewright.ui.
 ...
 * [dev.aarso.typewright.ui.glass.CommandPalette]'s own input row already prints for its prompt
...
public fun LearnScreen(
     ...
     * simulated pointer sequence needed -- the same reason [dev.aarso.typewright.ui.sheet.
