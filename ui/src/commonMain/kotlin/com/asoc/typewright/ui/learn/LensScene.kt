...
// [com.asoc.typewright.ui.learn.AnatomyLensData] measurements instead, and
// [com.asoc.typewright.ui.learn.AnatomyLensData]'s own KDoc ("Which qa/corpus function backs
...
// same real glyph(s) [com.asoc.typewright.ui.learn.anatomyLensEntry] itself measures; the
...
// file places a dot for: [com.asoc.typewright.qa.corpus.style.contrastRatio],
// [com.asoc.typewright.qa.corpus.style.stressAngleDegrees],
// [com.asoc.typewright.qa.corpus.style.superellipseExponent],
// [com.asoc.typewright.qa.corpus.style.apertureOpenness] and
// [com.asoc.typewright.qa.corpus.style.terminalStyle]'s own signatures were all checked before
...
/**
 * Per [AnatomyTerm], the real glyph character(s) [com.asoc.typewright.ui.learn.anatomyLensEntry]
 ...
 * [com.asoc.typewright.ui.learn.anatomyLensEntry] -- a real definition always, plus a real
 ...
 * string). Decimal formatting is [com.asoc.typewright.ui.tokens.toFixedString], the same
