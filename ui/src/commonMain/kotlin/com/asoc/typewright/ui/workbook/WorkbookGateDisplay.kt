...
import com.asoc.typewright.ui.tokens.toThousandsString
...
/**
 * One [WorkbookGateResult] check, ready to render: [heroText] is the check's own [com.asoc.
...
/**
 * Whether a [com.asoc.typewright.campaign.Demonstration.StatDemonstration.label] reads as a
