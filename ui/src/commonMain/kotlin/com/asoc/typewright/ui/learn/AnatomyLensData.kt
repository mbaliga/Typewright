...
import com.asoc.typewright.qa.corpus.style.apertureOpenness
import com.asoc.typewright.qa.corpus.style.contrastRatio
import com.asoc.typewright.qa.corpus.style.inkBounds
import com.asoc.typewright.qa.corpus.style.outerContour
import com.asoc.typewright.qa.corpus.style.serifMetrics
import com.asoc.typewright.qa.corpus.style.storeysFromA
import com.asoc.typewright.qa.corpus.style.storeysFromG
import com.asoc.typewright.qa.corpus.style.stressAngleDegrees
import com.asoc.typewright.qa.corpus.style.superellipseExponent
import com.asoc.typewright.qa.corpus.style.terminalStyle
import com.asoc.typewright.qa.corpus.style.xHeightToCapHeightRatio
...
/**
 * A coarse read of [com.asoc.typewright.qa.corpus.style.SerifMetrics.bracketScore]: only
 ...
 * is a *thin* one, and neither [com.asoc.typewright.qa.corpus.style.SerifMetrics.hasSerif] nor
 ...
 * measurement"). [SerifKind.BRACKETED]/[SerifKind.UNBRACKETED] split [bracketScore][com.asoc.typewright.qa.corpus.style.SerifMetrics.bracketScore]
...
/** This file's own split point on [com.asoc.typewright.qa.corpus.style.SerifMetrics.bracketScore] (0 = an abrupt, unbracketed step; up to ~1 = a smooth, fully bracketed curve), the midpoint of that documented range. Not a published rule -- see [serifEntry]'s KDoc. */
