...
import com.asoc.typewright.ui.tokens.MeaningColor
 ...
 *
 * [capHeightUnits]/[xHeightUnits] reuse [com.asoc.typewright.ui.learn.capHeightEntry]/
 * [com.asoc.typewright.ui.learn.xHeightEntry] (this same package's own Anatomy Lens wiring,
...
data class OverlayLayer(
     ...
     * comparison layer's identity is). A comparison layer's own [com.asoc.typewright.ui.tokens.MeaningColor],
     * one of [com.asoc.typewright.ui.tokens.MeaningColors.AMBER]/[com.asoc.typewright.ui.tokens.MeaningColors.MAGENTA]
...
/** `H`'s own drawn ink height, or [os2CapHeight] (only when positive) if `H` is missing -- the exact fallback order [com.asoc.typewright.ui.learn.capHeightEntry] already implements; unwrapped here to a plain nullable [Double] for [OverlayLayer]'s own alignment math. */
