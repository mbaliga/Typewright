 ...
 * (the same mono-label-plus-value row language [com.asoc.typewright.ui.glass.InspectorRow] and
 * [com.asoc.typewright.ui.puck.UnfoldedToolList] already use, not a new list-row style) and a
