...
/** The next value after [current] in [OPACITY_STEPS], wrapping -- pure and unit-tested ([LayersTest]) independently of the [LayersState] Compose holder that calls it, the same split [com.asoc.typewright.ui.puck.PuckGestureMachine]'s own pure-reducer-plus-Compose-holder pattern already establishes in this module. */
