...
import com.asoc.typewright.campaign.DEFAULT_TASK4_STYLE_KEY
import com.asoc.typewright.campaign.ShipMetadata
import com.asoc.typewright.campaign.WorkbookLatinContent
import com.asoc.typewright.campaign.WorkbookTask
import com.asoc.typewright.campaign.WorkbookTaskProgress
import com.asoc.typewright.campaign.campaignProgress
import com.asoc.typewright.campaign.currentWorkbookTaskIndex
import com.asoc.typewright.campaign.runAllWorkbookGates
...
sealed interface WorkbookCampaignSnapshot {
     ...
     * real call [com.asoc.typewright.campaign.WorkbookGates.task4ControlCharacters] itself makes
     * internally for task 4's own [WorkbookTaskProgress.gate] -- kept here too, separately, only
     * because it carries the raw per-glyph on-curve count and [com.asoc.typewright.qa.corpus.
     * Quartiles] box that [WorkbookGateRow]'s own compact `#s-workbook`-style display needs and a
     * [com.asoc.typewright.campaign.GateCheckResult]'s own prose [com.asoc.typewright.campaign.
