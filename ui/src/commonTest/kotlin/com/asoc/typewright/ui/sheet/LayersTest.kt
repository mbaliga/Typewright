...
/** [nextOpacityStep]'s own pure cycle -- Compose-free, matching [com.asoc.typewright.ui.puck.PuckGestureMachineTest]'s own pattern of testing a state holder's pure logic apart from its Compose wrapper. */
class LayersTest {
    @Test
