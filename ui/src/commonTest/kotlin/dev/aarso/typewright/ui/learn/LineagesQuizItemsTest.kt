...
import dev.aarso.typewright.learn.scenes.Align
import dev.aarso.typewright.learn.scenes.Caption
import dev.aarso.typewright.learn.scenes.Exercise
import dev.aarso.typewright.learn.scenes.ExerciseBankEntry
import dev.aarso.typewright.learn.scenes.FaceRef
import dev.aarso.typewright.learn.scenes.Scene
import dev.aarso.typewright.learn.scenes.Stage
import dev.aarso.typewright.learn.scenes.Strand
 ...
 * here is hand-built, never [dev.aarso.typewright.learn.scenes.LineagesResources] itself —
 * that reads `data/learn-faces/manifest.json`/scene YAML through
 * [dev.aarso.typewright.learn.scenes.readSceneResourceText], whose wasmJs actual is Node-`fs`-
