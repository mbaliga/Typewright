 ...
 * own [com.asoc.typewright.core.geometry.Contour.extrema] finds (each evaluated exactly with
 * [com.asoc.typewright.core.geometry.pointAt]) — the curve's own true extent, not the coarser box
