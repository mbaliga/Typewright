...
sealed class ArcPrimitive {
     ...
     * positive convention (matching [dev.aarso.typewright.engine.construct.rotate]).
     */
 ...
 * positive counter-clockwise, this module's own convention — [dev.aarso.typewright.engine.construct.rotate]'s
 * KDoc). This is deliberately not itself a `Contour` — like [dev.aarso.typewright.engine.construct.hobbySplineOpen],
 ...
 * [CirclePrimitive] is the case where a caller wants a *closed* full-turn arc as a [dev.aarso.typewright.core.geometry.Contour].
 */
