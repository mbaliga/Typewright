...
| `./gradlew :app-android:assembleDebug` | `app-android-debug.apk`, **23,647,702 bytes** (rechecked with `ls` 23 Sept). aapt2: `com.asoc.typewright`, SDK 37/31/36. `core-geometry` resolves to its `jvmRuntimeElements` variant |
